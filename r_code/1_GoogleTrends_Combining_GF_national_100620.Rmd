---
title: "Google Trends Cleaning - national level"
author: "Eli + Jackson Michaels"
date: "10/06/2020"
output: pdf_document
---

## renamed "region" to "names" in the starting directory. 
...
# run code
# Assumptions: 
# - Starting directory (below) is the parent directory in which data are stored
# - for each name, data is stored in a folder named after the person

# # National
starting_dir = '~/Box Sync/Research/Thu Projects/George Floyd Paper/Google/Data/National'
...
for (name in names)
{
     process_region(starting_dir, name)
}
